...
final class CoachSnapshotBuilderTests: XCTestCase {
    ...
    func test_charter_encodesPhilosophyMethodsAndAnswerFirst() {
        ...
        XCTAssertTrue(CoachCharter.instructions.contains("Never say they hit a goal the status says they missed"))
        XCTAssertTrue(CoachCharter.instructions.contains("Never state \"I will ...\" as your own plan."))
        XCTAssertTrue(CoachCharter.instructions.contains("Never name degrees, schools, titles"))
        XCTAssertTrue(CoachCharter.instructions.contains("three Ivy League doctorates"))
        XCTAssertTrue(CoachCharter.instructions.contains("LISTEN RULE"))
        XCTAssertTrue(CoachCharter.instructions.contains("Never print those tokens in chat"))
        XCTAssertTrue(CoachCharter.instructions.contains("consult your doctor"))
        XCTAssertTrue(CoachCharter.instructions.contains("Please seek immediate medical attention or professional help."))
        XCTAssertTrue(CoachCharter.instructions.contains("never say you are not a doctor")
            || CoachCharter.instructions.contains("Never say you are not a doctor"))
        ...
        XCTAssertTrue(CoachCharter.instructions.contains("world-renowned motivational speaker"))
        XCTAssertTrue(CoachCharter.instructions.contains("TOOLS:"))
